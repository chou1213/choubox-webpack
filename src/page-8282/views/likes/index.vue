...
<template>
    <div class="page">
        <!--条形图-->
        <div class="chart-wrap padding-top background-orange">
...
export default {
    ...
    data() {
        return {
            ...
            tableData: {
                // keyList: ['day', 'views', 'likes', 'comments', 'shares'],
                keyList: ['day', 'views', 'likes', 'shares'],
                labelList: [],
                dataList: []
            },
    ...
    created() {
        this.chartData['desc'] = this.curLang.lang017;
        // this.tableData['labelList'] = [this.curLang.lang018, this.curLang.lang019, this.curLang.lang020, this.curLang.lang021, this.curLang.lang022];
        this.tableData['labelList'] = [this.curLang.lang018, this.curLang.lang019, this.curLang.lang020, this.curLang.lang022];
    ...
    methods: {
        ...
        getChartData(timestamp) {
            const that = this;
            const key = format('yyyy-MM-dd', new Date(timestamp));
        ...
        getChartDataCallBack(res) {
            ...
            that.chartData['increaseNum'] = data.totalVideoLikes;
            dayArr.forEach(function (element, index) {
                let _num = data[element.day].videoLikes;
                _arr.push({
                    day: element.formatDay,
                    num: _num || 0,
                    compareWith: data[element.day].videoCompareFans,
                    views: data[element.day].videoViews,
                    likes: data[element.day].videoLikes,
                    comments: data[element.day].videoComments,
                    shares: data[element.day].videoShares
                })
            });
